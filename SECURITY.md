...
This document describes the security properties of the MongrelDB Java client
and how to report vulnerabilities.

## Overview

The MongrelDB Java client is a pure-Java library (no native dependencies)
...
The MongrelDB Java client has no runtime dependencies beyond the Java
...
- the MongrelDB Java client version, Java version, and OS,
